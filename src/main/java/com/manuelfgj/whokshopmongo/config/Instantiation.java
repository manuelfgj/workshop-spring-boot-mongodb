package com.manuelfgj.whokshopmongo.config;
...
import com.manuelfgj.whokshopmongo.dto.AuthorDTO;
import com.manuelfgj.whokshopmongo.dto.CommentDTO;
...
public class Instantiation implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		Post post1 = new Post(null, sdf.parse("21/03/2020"), "Partiu viagem", "Vou viajar", new AuthorDTO(maria));
